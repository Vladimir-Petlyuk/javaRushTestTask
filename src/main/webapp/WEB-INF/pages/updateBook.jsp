...
<div class="container myrow-container" style="margin-left: 150px;">
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            ...
            <form:form id="UserRegisterForm" cssClass="form-horizontal" modelAttribute="book" method="post" action="saveBook">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <form:input cssClass="form-control" path="adress" value="${book.adress}"/>
                    </div>
                </div>
                <br>
                <div class="form-group">
